...
func (x *Odom2DUpdate) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
type Lidar2DScan struct {
	...
	Timestamp      int64     `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // using timestamp stuff
...
func (x *Lidar2DScan) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
type NikolaiScan struct {
	...
	LidarScan *Lidar2DScan  `protobuf:"bytes,2,opt,name=lidar_scan,json=lidarScan,proto3" json:"lidar_scan,omitempty"`
}
...
func (x *NikolaiScan) GetLidarScan() *Lidar2DScan {
	if x != nil {
		return x.LidarScan
	}
	return nil
...
var file_sensor_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x65, 0x0a, 0x0b, 0x4e, 0x69, 0x6b, 0x6f, 0x6c, 0x61, 0x69, 0x53, 0x63, 0x61, 0x6e,
	...
	0x65, 0x52, 0x04, 0x6f, 0x64, 0x6f, 0x6d, 0x12, 0x2f, 0x0a, 0x0a, 0x6c, 0x69, 0x64, 0x61, 0x72,
	0x5f, 0x73, 0x63, 0x61, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x73,
	0x67, 0x2e, 0x4c, 0x69, 0x64, 0x61, 0x72, 0x32, 0x44, 0x53, 0x63, 0x61, 0x6e, 0x52, 0x09, 0x6c,
	0x69, 0x64, 0x61, 0x72, 0x53, 0x63, 0x61, 0x6e, 0x22, 0x3a, 0x0a, 0x10, 0x4e, 0x69, 0x6b, 0x6f,
	0x6c, 0x61, 0x69, 0x4d, 0x61, 0x6e, 0x79, 0x53, 0x63, 0x61, 0x6e, 0x73, 0x12, 0x26, 0x0a, 0x05,
	0x73, 0x63, 0x61, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x73,
	0x67, 0x2e, 0x4e, 0x69, 0x6b, 0x6f, 0x6c, 0x61, 0x69, 0x53, 0x63, 0x61, 0x6e, 0x52, 0x05, 0x73,
...
var file_sensor_proto_depIdxs = []int32{
	...
	1, // 1: msg.NikolaiScan.lidar_scan:type_name -> msg.Lidar2DScan
